...
We will build a “DawahGPT” prototype: a Retrieval-Augmented Generation (RAG) chatbot answering polemical and theological questions about Islam and other religions, trained on Sapience Institute, IERA, and related Dawah materials.
...
- **Human**:
  - Blind rating on faithfulness, clarity (1–5 scale).
...
6. Quran API integration for auto-citing verses.
